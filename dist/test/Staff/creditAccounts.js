...
describe('Test endpoints at "/api/v1/transactions/:account_number/credit" to credit a bank account with an amount as a signed in Staff with POST', function () {
  it('Should credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" with POST if all request inputs, headers and params are valid',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _index.chai.request(_index.app).post("/api/v1/transactions/".concat(accountNumber, "/credit")).set('cashier-id', testHeader).send(testData);
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if transaction amount is undefined',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if transaction amount is an empty string',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if transaction amount is null',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if transaction amount does not exist',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if transaction amount is not a number',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if cashier id is an empty string',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if cashier id is not a number',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if cashier id is null',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should NOT credit a bank account with an amount as a signed in Staff at "/api/v1/transactions/:account_number/credit" if cashier id is not registered',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
